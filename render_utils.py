...
# --- Lazy font cache ---------------------------------------------------
# pygame.font.SysFont() can't run until pygame.init() has happened, and we
# don't want every module that draws text to worry about import order --
# so fonts are created the first time they're actually needed and reused
# after that.
_fonts = {}
...
def build_slider_body_cache(screen_points, radius, fill_color):
    ...
    surface.set_alpha(CIRCLE_FILL_ALPHA)  # same see-through treatment as the hit circles
